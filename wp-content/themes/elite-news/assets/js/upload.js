...
jQuery(function($){
    ...
    jQuery(document).on('click', 'input.select-img', function( event ){
        ...
        var EliteNews = wp.media.controller.Library.extend({
            defaults :  _.defaults({
        ...
        elite_news_file_frame = wp.media.frames.elite_news_file_frame = wp.media({
            button: {
        ...
        elite_news_file_frame.on('select', function() {
            var state = elite_news_file_frame.state('author-insert-image');
